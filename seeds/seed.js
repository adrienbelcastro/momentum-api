...
exports.seedArticles = function () {
  connection
    .query(dropArticleTableSql)
    .then(function () {
      return getImageURL().then(function ({
        ...
        return connection.query(insertArticleTableSql, [
          {
...
exports.seed = function () {
  connection.query(dropUserTableSql);

  return connection.query(insertUserTableSql, [
    {
